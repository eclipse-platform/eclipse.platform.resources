...
public final class ResourcesPlugin extends Plugin {
	...
	/**
	 * Name of a preference for configuring the minimum amount of time in millseconds
	 * between workspace resource change notifications.
	 * @since 3.0
	 */
	public static final String PREF_MIN_NOTIFICATION_DELAY = "minnotifydelay"; //$NON-NLS-1$
