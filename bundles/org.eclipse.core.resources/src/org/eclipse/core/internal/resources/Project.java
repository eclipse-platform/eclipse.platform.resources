...
public class Project extends Container implements IProject {
	...
	protected ProjectPathVariableManager pathVariableManager;
	 ...
	 * (non-Javadoc)
	 * 
	 * @see IProject#getVariableRelativePathLocation(IPath)
	 */
	public IPath getVariableRelativePathLocation(IPath location) {
		try {
			IPath result = getPathVariableManager().convertToRelative(location, false, null);
