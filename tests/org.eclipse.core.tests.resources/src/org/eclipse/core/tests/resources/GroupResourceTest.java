...
public class GroupResourceTest extends ResourceTest {
	...
	protected void doCleanup() throws Exception {
		...
		ensureExistsInWorkspace(new IResource[] {existingProject, otherExistingProject, closedProject, existingFolderInExistingProject, existingFolderInExistingFolder, existingFileInExistingProject, existing_GROUP_InExistingProject}, true);
		closedProject.close(getMonitor());
		ensureDoesNotExistInWorkspace(new IResource[] {nonExistingProject, nonExistingFolderInExistingProject, nonExistingFolderInExistingFolder, nonExistingFolderInOtherExistingProject, nonExistingFolderInNonExistingProject, nonExistingFolderInNonExistingFolder, nonExistingFileInExistingProject, nonExistingFileInOtherExistingProject, nonExistingFileInExistingFolder, nonExistingFileInExistingGroup, nonExistingFolderInExistingGroup, nonExisting_GROUP_InExistingGroup, nonExisting_GROUP_InExistingProject, nonExisting_GROUP_InNonExistingFolder, nonExisting_GROUP_InNonExistingProject});
	...
	protected void setUp() throws Exception {
		...
		existing_GROUP_InExistingProject = existingProject.getFolder("existing_GROUP_InExistingProject");
		existing_GROUP_InExistingProject = existingProject.getFolder("existing_GROUP_InExistingProject");
		...
		nonExisting_GROUP_InExistingProject = existingProject.getFolder("nonExisting_GROUP_InExistingProject");
		...
		nonExisting_GROUP_InNonExistingFolder = nonExistingFolderInExistingProject.getFolder("nonExisting_GROUP_InNonExistingFolder");
		nonExistingFolderInExistingFolder = existingFolderInExistingProject.getFolder("nonExistingFolderInExistingFolder");
		nonExistingFolderInExistingGroup = existing_GROUP_InExistingProject.getFolder("nonExistingFolderInExistingGroup");
		nonExisting_GROUP_InExistingGroup = existing_GROUP_InExistingProject.getFolder("nonExisting_GROUP_InExistingGroup");
		nonExisting_GROUP_InExistingFolder = existingFolderInExistingProject.getFolder("nonExisting_GROUP_InExistingFolder");
		...
		nonExisting_GROUP_InNonExistingProject = nonExistingProject.getFolder("nonExisting_GROUP_InNonExistingProject");
		...
		nonExistingFileInExistingGroup = existing_GROUP_InExistingProject.getFile("nonExistingFileInExistingGroup");
	...
	public void testMoveProjectWithGroups() {
		...
		try {
			assertDoesNotExistInWorkspace("0.9", new IResource[] {folder, file, childFile});

			try {
				createFileInFileSystem(resolve(fileLocation));
				folder.createLink(localFolder, IResource.ALLOW_MISSING_LOCAL, getMonitor());
				file.createLink(fileLocation, IResource.ALLOW_MISSING_LOCAL, getMonitor());
			} catch (CoreException e) {
				fail("1.0", e);
			}
			...
			assertTrue("3.23", destination.isSynchronized(IResource.DEPTH_INFINITE));
	...
	public void testMoveProjectWithGroup() {
		...
		try {
			try {
				...
				file.createLink(fileLocation, IResource.ALLOW_MISSING_LOCAL, getMonitor());
				childFile.createLink(fileLocation, IResource.ALLOW_MISSING_LOCAL, getMonitor());
				IResource[] children = ((IContainer) folder).members(IContainer.INCLUDE_TEAM_PRIVATE_MEMBERS);
				assertTrue("0.9", children.length == 1);
			} catch (CoreException e) {
				fail("1.0", e);
			}

			assertExistsInWorkspace("1.5", new IResource[] {existingProject, file, folder});
